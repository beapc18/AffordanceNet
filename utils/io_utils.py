...
def get_model_path(model_type, backbone="vgg16"):
    ...
    model_path = os.path.join(main_path, "{}_{}_model_weights_sgd_no_dropout_reg_32.h5".format(model_type, backbone))
    return model_path
...
def handle_args():
    ...
    parser.add_argument("--config_file", required=False, default="config", help="Select config file to train")
