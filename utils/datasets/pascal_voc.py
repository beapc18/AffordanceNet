...
class pascal_voc(imdb):
    def __init__(self, image_set, year, dataset, devkit_path=None):
        ...
        self.cache_path = self._get_cache_dir()
    ...
    def _get_cache_dir(self):
        if self.dataset == 'iit':
            ...
            return os.path.join(cfg.DATA_DIR, 'cache_UMD')
    ...
    def _get_default_path(self):
        ...
        if self.dataset == 'iit':
            ...
            return os.path.join(cfg.DATA_DIR, 'VOCdevkit' + self._year + '_UMD')
    ...
    def _load_selective_search_roidb(self, gt_roidb):
        filename = os.path.abspath(os.path.join(cfg.VOC_DOWNLOAD_DIR,
    ...
    def _load_pascal_annotation(self, index):
        ...
        for ix, obj in enumerate(objs):
            ...
            if cfg.MASK_REG:
                ...
                #     pickle.dump(seg_mask_save, f_seg_save, pickle.HIGHEST_PROTOCOL)
...
if __name__ == '__main__':
    from affordance_net.datasets import pascal_voc
